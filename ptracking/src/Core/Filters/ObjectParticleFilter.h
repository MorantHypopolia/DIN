...
namespace PTracking
{
	...
	class ObjectParticleFilter : public manfield::ParticleFilter
	{
		private:
			...
			/**
			 * @brief true means that the tracking is performed on the image, otherwise it is performed by using a plan view.
			 */
			bool opticalTracker;
			...
			/**
			 * @brief Function that tries to apply group tracking when possible to improve the effectiveness of the method.
			 */
			void applyGroupTracking();
			 ...
			 */
			bool checkFilterForReinitialization();
